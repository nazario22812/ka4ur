...
public class App implements EventListener {
    public static void main(String[] args) {
        JDA jda = JDABuilder.createDefault("MTEzNjYyNDExMTkyNjM4MjY3Mg.G6Juuv.FMKOzfyuqCbJqew_Ifb2tQ2y39gYqy1cf3ArVw")
            .addEventListeners(new Events())
            .addEventListeners(new Information())
            .addEventListeners(new Moderation())
            .addEventListeners(new Music())
            .enableIntents(GatewayIntent.GUILD_MESSAGES, GatewayIntent.DIRECT_MESSAGES, GatewayIntent.MESSAGE_CONTENT, GatewayIntent.GUILD_MEMBERS, GatewayIntent.GUILD_PRESENCES, GatewayIntent.AUTO_MODERATION_CONFIGURATION, GatewayIntent.GUILD_MODERATION)// Enable the bulk delete event
        ...
        jda.upsertCommand("user", "Show information about user")
                ...
                .queue();
        jda.upsertCommand("bio", "You can add biografy").queue();
