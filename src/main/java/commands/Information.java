...
//            event.reply("You just farted").queue();
            ...
            embed.addField("Інформація (/help info):", " `/help` `/info` `/stats` `/serverinfo` `/user` `/bio`",false);
            ...
            if(optionMapping != null){
                ...
                boolean checker =  sql.biocheck(gld.getName(), user.getIdLong());
                ...
                String fullname = member.getEffectiveName();



                if (checker != true){
                    embed.setTitle("Інформація про " + user.getEffectiveName());
                    embed.setDescription("Також ти можеш додати додаткову інформацію про себе використовуючи `/bio`");
                    ...
                    embed.setTitle("Інформація про " + user.getEffectiveName());
                    sql.getbio(gld.getName(), user.getIdLong());
                    embed.setDescription(sql.getbio(gld.getName(), user.getIdLong()));
                    embed.addField("Звичайна інформація\nНікнейм:", "" + name + "(" + fullname + ")", false);
                    //embed.addField("Cтатус:","" + status,false);
                    embed.addField("Приєднався:", "" + join + " (`" + daysPassed + "дні тому`)", false);
                    embed.addField("Зареєструвався:", "" + registed + " (`" + daysPassed1 + "дні тому`)", false);
                ...
                sql.biocheck(gld.getName(), user.getIdLong());
                ...
                //embed.addField("","",false);
                embed.addField("Звичайна інформація\nНікнейм:","" + user.getName() + "(" + member.getEffectiveName() + ")",false);
                //embed.addField("Cтатус:","" + member.getOnlineStatus(),false);
                embed.addField("Приєднався:","" + join + " (`" + daysPassed + "дні тому`)",false);
                embed.addField("Зареєструвався:","" + registed + " (`" + daysPassed1 + "дні тому`)",false);
            ...
            System.out.println("" + gld.getName());
